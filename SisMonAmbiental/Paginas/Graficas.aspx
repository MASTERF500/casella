<%@ Page Title="" Language="C#" MasterPageFile="~/Paginas/MasterP.Master" AutoEventWireup="true" CodeBehind="Graficas.aspx.cs" Inherits="SisMonAmbiental.Paginas.Graficas" %>
                ...
                <table style="width: 100%;">
                    ...
                    <tr>
                        <td>
                            ...
                            <asp:ImageButton ID="ImageButton1" runat="server" ImageUrl="~/Paginas/icons/calendar.png" AlternateText="Calendario" Height="24px" Width="26px" />
                            <br />
                        </td>
                        <td style="text-align:right;">
                            <asp:LinkButton ID="LinkButtonReporteador" runat="server" OnClick="LinkButtonReporteador_Click">Reporteador...</asp:LinkButton>
                        </td>
                    </tr>
                </table>
                <br />
